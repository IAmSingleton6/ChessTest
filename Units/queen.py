...
class Queen(BaseUnit):
    black_image_path = 'Images/bQ.png'
    white_image_path = 'Images/wQ.png'
    ...
    def moveable_squares(self, pos, board):
        ...
        output = self.filter_directions(board, moves_e, moves_n, moves_s, moves_w, moves_ne, moves_se, moves_nw, moves_sw)
        return output
